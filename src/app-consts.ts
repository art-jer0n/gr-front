...
export const NEWS: NewsItem[] = [
  {
    ...
    content:
      'Сегодня в Женеве состоялась встреча глав государств, на которой было подписано историческое соглашениеa о расширении экономического сотрудничества и укреплении экологической безопасности.',
...
export const EVENTS: CalendarEvent[] = [
  {
    ...
    text: 'Запуск нового маркетингового проекта. Обсуждение стратегии продвижения на квартал.'
  },
  {
    id: 2,
    date: new Date(2025, 3, 5),
    text: 'Техническое обслуживание серверов. Запланированный даунтайм с 02:00 до 05:00 по московскому времени.'
  },
  {
    id: 3,
    date: new Date(2025, 3, 10),
    text: 'Ежеквартальное собрание акционеров. Повестка: финансовые результаты, новые назначения.'
  },
  {
    id: 4,
    date: new Date(2025, 3, 12),
    text: 'Корпоративное обучение: "Эффективное управление проектами". Тренер: Иван Петров.'
  },
  {
    id: 5,
    date: new Date(2025, 3, 15),
    text: 'Выпуск новой версии продукта. Основные изменения: обновленный интерфейс, улучшенная безопасность.'
  },
  {
    id: 6,
    date: new Date(2025, 3, 18),
    text: 'Встреча с ключевыми клиентами. Обсуждение новых требований к функционалу платформы.'
  },
  {
    id: 7,
    date: new Date(2025, 3, 20),
    text: 'День рождения компании (10 лет). Торжественное мероприятие в главном офисе с 15:00.'
  },
  {
    id: 8,
    date: new Date(2025, 3, 20),
    text: 'Презентация нового отдела разработки. Знакомство с новыми сотрудниками и их проектами.'
  },
  {
    id: 9,
    date: new Date(2025, 3, 22),
    text: 'Хакатон для разработчиков. Тема: "Инновационные решения в области искусственного интеллекта".'
  },
  {
    id: 10,
    date: new Date(2025, 3, 25),
    text: 'Воркшоп по UX/UI дизайну. Разбор кейсов и лучших практик современного дизайна интерфейсов.'
  },
  {
    id: 11,
    date: new Date(2025, 3, 28),
    text: 'Финал внутреннего конкурса инновационных проектов. Награждение победителей.'
  },
  {
    id: 12,
    date: new Date(2025, 3, 30),
    text: 'Подготовка к майским праздникам. Короткий день до 15:00, техподдержка работает в обычном режиме.'
  }
];
